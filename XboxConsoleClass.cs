...
namespace XDevkit
{
  ...
  public class XboxConsoleClass : IXboxConsole, XboxConsole, XboxEvents_Event
  {
    ...
    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void add_OnStdNotify([In] XboxEvents_OnStdNotifyEventHandler obj0);

    public virtual extern event XboxEvents_OnStdNotifyEventHandler OnStdNotify;

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void remove_OnStdNotify([In] XboxEvents_OnStdNotifyEventHandler obj0);

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void add_OnTextNotify([In] XboxEvents_OnTextNotifyEventHandler obj0);

    public virtual extern event XboxEvents_OnTextNotifyEventHandler OnTextNotify;

    [MethodImpl(MethodImplOptions.InternalCall, MethodCodeType = MethodCodeType.Runtime)]
    public virtual extern void remove_OnTextNotify([In] XboxEvents_OnTextNotifyEventHandler obj0);
  }
}
